...
<h2 className="text-2xl text-palette5 mb-5">Featured Projects</h2>
        ...
        <div className="block shadow-lg p-4 bg-palette5 text-palette2 dark:bg-neutral-700">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto md:w-8/12">
              <div className="px-6 py-12 md:px-12">
                ...
                <p className="mb-6 pb-2 text-palette2  dark:text-neutral-300">
      ...
      <section className=" text-center md:text-left p-6">
        <div className="block  shadow-lg p-4  bg-palette5 text-palette2  dark:bg-neutral-700">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full shrink-0 grow-0 basis-auto md:w-8/12 ">
              <div className="px-6 py-12 md:px-12 rounded-md">
                <h2 className="mb-6 text-3xl  text-palette2   font-bold">
                  <span className=" text-palette2   ">Investment Calculator</span> 
                </h2>
                <p className="mb-6 pb-2  text-palette2  dark:text-neutral-300">

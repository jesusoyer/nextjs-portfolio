    ...
    <div className="container my-52 mx-auto md:px-6">
      ...
      <section className="mb-32 ">
        <div className="container px-6 md:px-12">
          <div className="block bg-black rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
              ...
              <div className="mx-auto mb-12 text-center lg:mb-0">
                ...
                >
                  <svg
                    ...
                    strokeWidth="2"
                    stroke="blue"
                    className="mx-auto mb-6 h-8 w-8 text-white dark:text-primary-400"
                  >
                    <path
                      strokeLinecap="round"
